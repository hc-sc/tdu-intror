...
#we will need the dplyr (a tidyverse core) and tidyr packages for many of the examples below
library(dplyr)
library(tidyr)
...
#the specific variable to convert to a date variable from character 
