...
# First create a new data frame called location_cases that includes the location of all the cases (on or off reserve) and their classification (i.e. case).
...
# Create a contact data frame called location_contacts with the same columns you created for cases above (Classification and Location).
...
# Bind case location and contact location lists together so that the cases and contacts are in one column in a data frame
